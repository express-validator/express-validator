...
describe('#isEmpty()', () => {
  it('returns whether there are errors', () => {
    ...
    result = validationResult({ [errors]: allErrors });
...
describe('#array()', () => {
  it('returns all errors', () => {
    const result = validationResult({ [errors]: allErrors });
...
describe('#formatWith()', () => {
  ...
  it('sets a new formatter that is used with #array()', () => {
    ...
    const result = validationResult({ [errors]: allErrors }).formatWith(formatter);
...
describe('.withDefaults()', () => {
  it('lets specify custom default formatter', () => {
    ...
    let result = customFactory({ [errors]: allErrors });
    expect(result.array()).toEqual(allErrors.map(formatter));
