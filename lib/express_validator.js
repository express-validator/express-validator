...
var expressValidator = function(options) {
  ...
  _.forEach(options.customValidators, function(method, customValidatorName) {
    ValidatorChain.prototype[customValidatorName] = utils.makeValidator(customValidatorName, options.customValidators);
  });

  _.forEach(options.customSanitizers, function(method, customSanitizerName) {
    Sanitizer.prototype[customSanitizerName] = utils.makeSanitizer(customSanitizerName, options.customSanitizers);
  });
