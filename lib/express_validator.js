...
function validateSchema(schema, req, loc, options) {
  ...
  for (var param in schema) {
    ...
    // Since javascript object keys have order we explicitly call optional validator very first
    if (schema[param].hasOwnProperty('optional')) {
